...
private final class NSAttributedStringTests: XCTestCase {
    ...
    var mentionAttributesClosure: ((CreateMention?) -> [SZMentionsSwift.AttributeContainer])!
    ...
    func test_textViewTypingAttributes_shouldReset() {
        ...
        textView.typingAttributes = (defaultAttributes! as [SZMentionsSwift.AttributeContainer]).dictionary
